package com.jaimerojas.springboot.backend.apirest.controller;
...
public class ClienteRestController {
	...
	public ResponseEntity<?> update(@Valid @RequestBody Cliente cliente, BindingResult result,@PathVariable Long id) {
		...
		if (clienteActual == null) {
			response.put("mensaje", "Error: no se puedo editar el cliente con el ID: "
					.concat(id.toString().concat(" en la base de datos!")));
			return new ResponseEntity<Map>(response, HttpStatus.NOT_FOUND);
		}
		try {
